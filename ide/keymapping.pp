...
//    ecInsertCharacter         : Result:= srkmecInsertCharacter;
    ...
    ecToggleWatches           : Result:= lisKMToggleViewWatches;
    ecToggleBreakPoints       : Result:= lisKMToggleViewBreakpoints;
    ecToggleDebuggerOut       : Result:= lisKMToggleViewDebuggerOutput;
    ecToggleLocals            : Result:= lisKMToggleViewLocalVariables;
    ecViewThreads             : Result:= lisKMToggleViewThreads;
    ecViewPseudoTerminal      : Result:= lisKMToggleViewPseudoTerminal;
    ecToggleCallStack         : Result:= lisKMToggleViewCallStack;
    ecToggleRegisters         : Result:= lisKMToggleViewRegisters;
    ecToggleAssembler         : Result:= lisKMToggleViewAssembler;
    ecToggleMemViewer         : Result:= srkmecToggleMemViewer;
    ecViewHistory             : Result:= lisKMToggleViewHistory;
