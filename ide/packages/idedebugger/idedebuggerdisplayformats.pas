...
begin
  ...
  ADisplayFormat.DataAddr.UseInherited := AConfig.GetValue(APath + 'DataAddrInherit', DefaultWatchDisplayFormat.DataAddr.UseInherited);
   //AConfig.GetValue(APath + 'DataAddrType',  ord(DefaultWatchDisplayFormat.DataAddr.TypeFormat),     ADisplayFormat.DataAddr.TypeFormat,    TypeInfo(TValueDisplayFormatAddress));
   AConfig.GetValue(APath + 'DataAddrBase',  ord(DefaultWatchDisplayFormat.DataAddr.BaseFormat),        ADisplayFormat.DataAddr.BaseFormat,       TypeInfo(TValueDisplayFormatBase));
   ADisplayFormat.DataAddr.Signed       := AConfig.GetValue(APath + 'DataAddrSign', DefaultWatchDisplayFormat.DataAddr.Signed);
   ADisplayFormat.DataAddr.NoLeadZero   := AConfig.GetValue(APath + 'DataAddrLeadZero', DefaultWatchDisplayFormat.DataAddr.NoLeadZero);
  ...
  ADisplayFormat.AddrPrefix.UseInherited := AConfig.GetValue(APath + 'AddrPrefixInherit', DefaultWatchDisplayFormat.AddrPrefix.UseInherited);
   AConfig.GetValue(APath + 'AddrPrefixHex',   ord(DefaultWatchDisplayFormat.AddrPrefix.HexPrefix),            ADisplayFormat.AddrPrefix.HexPrefix,           TypeInfo(TValueDisplayFormatHexPrefix));
   AConfig.GetValue(APath + 'AddrPrefixOct',   ord(DefaultWatchDisplayFormat.AddrPrefix.OctPrefix),            ADisplayFormat.AddrPrefix.OctPrefix,           TypeInfo(TValueDisplayFormatOctPrefix));
   AConfig.GetValue(APath + 'AddrPrefixBin',   ord(DefaultWatchDisplayFormat.AddrPrefix.BinPrefix),            ADisplayFormat.AddrPrefix.BinPrefix,           TypeInfo(TValueDisplayFormatBinPrefix));
...
begin
  ...
  AConfig.SetDeleteValue(APath + 'DataAddrInherit', ADisplayFormat.DataAddr.UseInherited,       DefaultWatchDisplayFormat.DataAddr.UseInherited);
   //AConfig.SetDeleteValue(APath + 'DataAddrType',       ADisplayFormat.DataAddr.TypeFormat,       ord(DefaultWatchDisplayFormat.DataAddr.TypeFormat),    TypeInfo(TValueDisplayFormatAddress));
   AConfig.SetDeleteValue(APath + 'DataAddrBase',       ADisplayFormat.DataAddr.BaseFormat,   ord(DefaultWatchDisplayFormat.DataAddr.BaseFormat),       TypeInfo(TValueDisplayFormatBase));
   AConfig.SetDeleteValue(APath + 'DataAddrSign',       ADisplayFormat.DataAddr.Signed,       DefaultWatchDisplayFormat.DataAddr.Signed);
   AConfig.SetDeleteValue(APath + 'DataAddrLeadZero',   ADisplayFormat.DataAddr.NoLeadZero,   DefaultWatchDisplayFormat.DataAddr.NoLeadZero);
  ...
  AConfig.SetDeleteValue(APath + 'AddrPrefixInherit',   ADisplayFormat.AddrPrefix.UseInherited,       DefaultWatchDisplayFormat.AddrPrefix.UseInherited);
   AConfig.SetDeleteValue(APath + 'AddrPrefixHex',      ADisplayFormat.AddrPrefix.HexPrefix,    ord(DefaultWatchDisplayFormat.AddrPrefix.HexPrefix),    TypeInfo(TValueDisplayFormatHexPrefix));
   AConfig.SetDeleteValue(APath + 'AddrPrefixOct',      ADisplayFormat.AddrPrefix.OctPrefix,    ord(DefaultWatchDisplayFormat.AddrPrefix.OctPrefix),    TypeInfo(TValueDisplayFormatOctPrefix));
   AConfig.SetDeleteValue(APath + 'AddrPrefixBin',      ADisplayFormat.AddrPrefix.BinPrefix,    ord(DefaultWatchDisplayFormat.AddrPrefix.BinPrefix),    TypeInfo(TValueDisplayFormatBinPrefix));
