...
type
  ...
  private
    ...
    fConstantAttri: TLazEditHighlighterAttributes;
    fObjectAttri: TLazEditHighlighterAttributes;
    fNumberAttri: TLazEditHighlighterAttributes;
    fPreprocessorAttri: TLazEditHighlighterAttributes;
    ...
    FMarkup: boolean;
    FEntity: boolean;
    fEntityAttri: TLazEditHighlighterAttributes;
    FDollarVariables: boolean;
    fVariableAttri: TLazEditHighlighterAttributes;
    FActiveDot: boolean;
    FDotAttri: TLazEditHighlighterAttributes;
    ...
    procedure SetAttribute(AIndex: TSynPasAttribute; AValue: TLazEditHighlighterAttributes);
    procedure SlashProc;
    procedure SpaceProc;
  ...
  published
    ...
    property ConstantAttri: TLazEditHighlighterAttributes index attribConstant read fConstantAttri write SetAttribute;
    property ObjectAttri: TLazEditHighlighterAttributes index attribObject read fObjectAttri write SetAttribute;
    property EntityAttri: TLazEditHighlighterAttributes index attribEntity read fEntityAttri write SetAttribute;
    property VariableAttri: TLazEditHighlighterAttributes index attribVariable read fVariableAttri write SetAttribute;
    property DotAttri: TLazEditHighlighterAttributes index attribDot read FDotAttri write SetAttribute;
    ...
    property PreprocessorAttri: TLazEditHighlighterAttributes index attribPreprocessor read fPreprocessorAttri write SetAttribute;
...
begin
  ...
  fVariableAttri := TLazEditHighlighterAttributes.Create('jan_Variable');
  fVariableAttri.Style := [fsBold];
  fVariableAttri.Foreground:=clpurple;
  AddAttribute(fVariableAttri);
  fPreprocessorAttri := TLazEditHighlighterAttributes.Create(@SYNS_AttrPreprocessor, SYNS_XML_AttrPreprocessor);
...
procedure TSynAnySyn.SetAttribute(AIndex: TSynPasAttribute; AValue: TLazEditHighlighterAttributes);
begin
  case AIndex of
...
function TSynAnySyn.GetTokenClassAttribute(ATkClass: TLazEditTokenClass;
...
begin
  case ATkClass of
    ...
    tcDirective: Result := fPreprocessorAttri;
  else
    Result := nil;
  end;
end;
...
var
  ...
  procedure ReadAttribute(attr:TLazEditHighlighterAttributes;attrname:string);
  begin
    s:='';
