...
//---MS-SQL2K-------------------------------------------------------------------
  ...
  MSSQL2000KW =
    ...
    'OPTION,OR,ORDER,OUTER,OVER,PARTITION,PERCENT,PLAN,PRECISION,' +
...
//---MS-SQL---------------------------------------------------------------------
  ...
  MSSQLKW =
    ...
    'OR,ORDER,OUTER,OUTPUT,OVER,OVERLAPS,PAD,PARTIAL,PARTITION,PASCAL,PERCENT,' +
    'PIVOT,PLAN,POSITION,PRECISION,PREPARE,PRESERVE,PRIMARY,PRINT,PRIOR,' +
...
begin
  ...
  if not (fTokenID in [tkSpace, tkComment, tkNull]) then
