...
type
  ...
  private
    ...
    fDocStringAttri: TLazEditHighlighterAttributes;
    fNumberAttri: TLazEditHighlighterAttributes;
    fHexAttri: TLazEditHighlighterAttributes;
    fOctalAttri: TLazEditHighlighterAttributes;
    fFloatAttri: TLazEditHighlighterAttributes;
    fKeyAttri: TLazEditHighlighterAttributes;
    fNonKeyAttri: TLazEditHighlighterAttributes;
    fSystemAttri: TLazEditHighlighterAttributes;
    ...
    fErrorAttri: TLazEditHighlighterAttributes;
  ...
  published
    ...
    property NonKeyAttri: TLazEditHighlighterAttributes index attribNonKey read fNonKeyAttri write SetAttribute;
    property SystemAttri: TLazEditHighlighterAttributes index attribSystem read fSystemAttri write SetAttribute;
    property NumberAttri: TLazEditHighlighterAttributes index attribNumber read fNumberAttri write SetAttribute;
    property HexAttri: TLazEditHighlighterAttributes index attribHex read fHexAttri write SetAttribute;
    property OctalAttri: TLazEditHighlighterAttributes index attribOctal read fOctalAttri write SetAttribute;
    property FloatAttri: TLazEditHighlighterAttributes index attribFloat read fFloatAttri write SetAttribute;
    ...
    property DocStringAttri: TLazEditHighlighterAttributes index attribDocString read fDocStringAttri write SetAttribute;
    property SymbolAttri: TLazEditHighlighterAttributes index attribSymbol read fSymbolAttri write SetAttribute;
    property ErrorAttri: TLazEditHighlighterAttributes index attribError read fErrorAttri write SetAttribute;
  end;
...
begin
  ...
  fNonKeyAttri := TLazEditHighlighterAttributes.Create(@SYNS_AttrNonReservedKeyword, SYNS_XML_AttrNonReservedKeyword);
  fNonKeyAttri.Foreground := clNavy;
  fNonKeyAttri.Style := [fsBold];
  AddAttribute (fNonKeyAttri);
  fSystemAttri := TLazEditHighlighterAttributes.Create(@SYNS_AttrSystem, SYNS_XML_AttrSystem);
  ...
  fHexAttri := TLazEditHighlighterAttributes.Create(@SYNS_AttrHexadecimal, SYNS_XML_AttrHexadecimal);
  fHexAttri.Foreground := clBlue;
  AddAttribute(fHexAttri);
  fOctalAttri := TLazEditHighlighterAttributes.Create(@SYNS_AttrOctal, SYNS_XML_AttrOctal);
  fOctalAttri.Foreground := clBlue;
  AddAttribute(fOctalAttri);
  fFloatAttri := TLazEditHighlighterAttributes.Create(@SYNS_AttrFloat, SYNS_XML_AttrFloat);
  ...
  fDocStringAttri := TLazEditHighlighterAttributes.Create(@SYNS_AttrDocumentation, SYNS_XML_AttrDocumentation);
  ...
  fErrorAttri := TLazEditHighlighterAttributes.Create(@SYNS_AttrSyntaxError, SYNS_XML_AttrSyntaxError);
...
procedure TSynPythonSyn.SetAttribute(AnIndex: TSynPasAttribute; AValue: TLazEditHighlighterAttributes);
begin
  case AnIndex of
