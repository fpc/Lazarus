...
type
  ...
  private
    ...
    fNonReservedKeyAttri: TLazEditHighlighterAttributes;
    fEventAttri: TLazEditHighlighterAttributes;
  ...
  published
    ...
    property NonReservedKeyAttri: TLazEditHighlighterAttributes index attribNonReservedKey read fNonReservedKeyAttri write SetAttribute;
    property EventAttri: TLazEditHighlighterAttributes index attribEvent read fEventAttri write SetAttribute;
...
begin
  ...
  FBracketAttri := TLazEditHighlighterAttributes.Create(@SYNS_AttrBrackets, SYNS_XML_AttrBrackets);
  ...
  fNonReservedKeyAttri := TLazEditHighlighterAttributes.Create(@SYNS_AttrNonReservedKeyword, SYNS_XML_AttrNonReservedKeyword);
  AddAttribute(fNonReservedKeyAttri);
  fEventAttri := TLazEditHighlighterAttributes.Create(@SYNS_AttrEvent, SYNS_XML_AttrEvent);
...
procedure TSynJScriptSyn.InitForScanningLine;
begin
  inherited;
  Run := 0;
  FAtLineStart := True;
...
procedure TSynJScriptSyn.SetAttribute(AnIndex: TSynPasAttribute; AValue: TLazEditHighlighterAttributes
  );
begin
  case AnIndex of
