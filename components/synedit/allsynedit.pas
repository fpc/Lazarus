...
uses
  ...
  SynHighlighterXML, SynHighlighterMarkdown, SynMacroRecorder, SynMemo, 
  SynPluginSyncroEdit, SynPluginSyncronizedEditBase, SynPluginTemplateEdit, 
  LazSynEditText, LazSynTextArea, SynEditMarkupGutterMark, SynHighlighterBat, 
  ...
  SynEditTextDynTabExpander, SynTextMateSyn, SynPluginExternalLink, 
  LazarusPackageIntf;
