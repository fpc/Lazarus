...
uses
  ...
  SynHighlighterXML, SynHighlighterMarkdown, SynMacroRecorder, SynMemo, SynPluginSyncroEdit, 
  ...
  SynEditTextDynTabExpander, SynTextMateSyn, SynPluginExternalLink, SynPluginAutoBraces, 
  LazarusPackageIntf;
