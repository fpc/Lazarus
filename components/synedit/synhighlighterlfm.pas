...
procedure TSynLFMSyn.InitForScanningLine;
begin
  inherited;
  Run := 0;
  Next;
...
procedure TSynLFMSyn.SetAttribute(AnIndex: TSynPasAttribute; AValue: TLazEditHighlighterAttributes);
begin
  case AnIndex of
...
function TSynLFMSyn.GetTokenClassAttribute(ATkClass: TLazEditTokenClass;
