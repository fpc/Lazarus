...
Type
  ...
  TJSNavigationPreloadState = class (TJSObject);
  ...
  TJSIdleCallbackOptions = class (TJSObject);
  TJSIdleDeadline = class (TJSObject);
  ...
  TJSHTMLTableSectionElement = class (TJSHTMLElement);
  TJSHTMLTableRowElement = class (TJSHTMLElement);
  ...
  TJSFileSystemWritableFileStream = class(TJSObject);
  TJSFileSystemHandle = class (TJSObject);
  TJSFileSystemFileHandle = class (TJSFileSystemHandle);
  TJSGetFileHandleOptions = class (TJSObject);
