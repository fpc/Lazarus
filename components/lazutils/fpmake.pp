...
begin
  with Installer do
    ...
    t.Dependencies.AddUnit('lazlistclassesbase');
    ...
    t.Dependencies.AddUnit('lazmemmanager');
    ...
    t.Dependencies.AddUnit('lazvcsutils');
    ...
    t.Dependencies.AddUnit('plist2json');
    t.Dependencies.AddUnit('projresconvert');
    t.Dependencies.AddUnit('projresproc');
    ...
    T:=P.Targets.AddUnit('lazlistclassesbase.pas');
    ...
    T:=P.Targets.AddUnit('lazmemmanager.pas');
    ...
    T:=P.Targets.AddUnit('laztty.pas');
    ...
    T:=P.Targets.AddUnit('lazvcsutils.pas');
    ...
    T:=P.Targets.AddUnit('plist2json.pas');
    T:=P.Targets.AddUnit('projresconvert.pas');
    T:=P.Targets.AddUnit('projresproc.pas');
