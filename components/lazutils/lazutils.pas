...
uses
  ...
  LazUTF8, LazUtilities, LazUtilsStrConsts, LazVersion, LConvEncoding, 
  LCSVUtils, LookupStringList, Maps, Masks, ObjectLists, PList2JSon, 
  ProjResProc, StringHashList, TextStrings, Translations, UTF8Process, 
  LazarusPackageIntf;
