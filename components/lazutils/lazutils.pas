...
uses
  ...
  LazUTF8, LazUtilities, LazUtilsStrConsts, LazVCSUtils, LazVersion, 
  LConvEncoding, LCSVUtils, LookupStringList, Maps, Masks, ObjectLists, 
  PList2JSon, ProjResConvert, ProjResProc, StringHashList, TextStrings, 
  Translations, UTF8Process, LazarusPackageIntf;
