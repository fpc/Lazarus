...
begin
  ...
  if FormattingSettings.Clarify.OnceOffs = eRunOnly then
  begin
    // run only the once-offs
    OnceOffs;
  end
  else if FormattingSettings.Obfuscate.Enabled then
  begin
    Obfuscate;
  end
  else
  begin
    ...
    if FormattingSettings.Clarify.OnceOffs = eDoRun then
      OnceOffs;
