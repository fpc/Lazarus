...
const
  ...
  LazVersions: array [0..MaxLazVersions - 1] of String = (
    '2.0.x', '2.2.x',                               // order from old to young
    '3.0.0', '3.2.0', '3.4.0', '3.6.0', '3.8.0',
    '4.0.0', '4.2.0', '4.4.0', '4.6.0', '4.8.0',
    'Trunk');
  LazDefVersions = '4.8.0, 4.6.0, 4.4.0, 4.2.0, 4.0.0, 3.8.0, 3.6.0, 3.4.0, 3.2.0, 3.0.0';
  LazTrunk = '4.99.0';

  MaxFPCVersions = 7;
  FPCVersions: array [0..MaxFPCVersions - 1] of String = (
    '3.0.0', '3.0.2', '3.0.4', '3.2.0', '3.2.2', '3.2.4',   // order from old to young
    'Trunk');
  FPCDefVersion = '3.2.2, 3.2.0';
  FPCTrunk = '3.3.1';
