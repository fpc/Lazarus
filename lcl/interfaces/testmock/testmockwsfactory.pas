...
uses
  Classes, Controls, Forms, Menus, TestMockWSMenus, WSLCLClasses;
  //, ComCtrls, ImgList, Calendar, StdCtrls, Spin,
...
implementation
uses
  TestMockWSControls, TestMockWSForms;
...
begin
  RegisterWSComponent(TControl, TTestMockWSControl);
  Result := True;
end;

function RegisterWinControl: Boolean; alias : 'WSRegisterWinControl';
begin
  RegisterWSComponent(TWinControl, TTestMockWSWinControl);
  Result := True;
end;

function RegisterGraphicControl: Boolean; alias : 'WSRegisterGraphicControl';
begin
  RegisterWSComponent(TGraphicControl, TTestMockWSGraphicControl);
  Result := True;
end;

function RegisterCustomControl: Boolean; alias : 'WSRegisterCustomControl';
begin
  RegisterWSComponent(TCustomControl, TTestMockWSCustomControl);
  Result := True;
end;
...
begin
  RegisterWSComponent(TScrollingWinControl, TTestMockWSScrollingWinControl);
  Result := True;
end;

function RegisterScrollBox: Boolean; alias : 'WSRegisterScrollBox';
begin
  RegisterWSComponent(TScrollBox, TTestMockWSScrollBox);
  Result := True;
end;

function RegisterCustomFrame: Boolean; alias : 'WSRegisterCustomFrame';
begin
  RegisterWSComponent(TCustomFrame, TTestMockWSCustomFrame);
  Result := True;
end;

function RegisterCustomForm: Boolean; alias : 'WSRegisterCustomForm';
begin
  RegisterWSComponent(TCustomForm, TTestMockWSCustomForm);
  Result := True;
end;

function RegisterHintWindow: Boolean; alias : 'WSRegisterHintWindow';
begin
  RegisterWSComponent(THintWindow, TTestMockWSHintWindow);
  Result := True;
end;
...
begin
  RegisterWSComponent(TMenuItem, TTestMockWSMenuItem);
  Result := True;
end;

function RegisterMenu: Boolean; alias : 'WSRegisterMenu';
begin
  RegisterWSComponent(TMenu, TTestMockWSMenu);
  Result := True;
end;

function RegisterMainMenu: Boolean; alias : 'WSRegisterMainMenu';
begin
  RegisterWSComponent(TMainMenu, TTestMockWSMainMenu);
  Result := True;
end;

function RegisterPopupMenu: Boolean; alias : 'WSRegisterPopupMenu';
begin
  RegisterWSComponent(TPopupMenu, TTestMockWSPopupMenu);
  Result := True;
end;
