...
C_EXPORT void QPixmap_deviceIndependentSize(QPixmapH handle, QSizeFH retval);
...
C_EXPORT void QPixmap_transformed(QPixmapH handle, QPixmapH retval, const QTransformH AnonParam1, Qt::TransformationMode mode);
C_EXPORT void QPixmap_trueMatrix(QTransformH retval, const QTransformH m, int w, int h);
