...
C_EXPORT void QScreen_model(QScreenH handle, PWideString retval);
C_EXPORT void QScreen_manufacturer(QScreenH handle, PWideString retval);
C_EXPORT void QScreen_name(QScreenH handle, PWideString retval);
C_EXPORT void QScreen_serialNumber(QScreenH handle, PWideString retval);
...
C_EXPORT QScreenH QScreen_virtualSiblingAt(QScreenH handle, PQtPoint point);
