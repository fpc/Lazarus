...
InstallQt=Installer globalement la DLL de l'interface Qt 
...
FolderHasSpaces=Le nom du dossier choisi contient des espaces : veuillez sélectionner un dossier sans espaces.
...
FolderForSecondBadFile=Le dossier de destination n'est pas vide. Le programme d'installation n'a pas pu détecter s'il contient une installation secondaire de Lazarus pouvant être mise à jour.%0:sVeuillez choisir un dossier vide ou un dossier avec une installation secondaire existante de Lazarus à mettre à jour.
...
FolderForSecondUpgradingPrimary=Le dossier de destination n'est pas vide.%0:sIl contient une installation (non secondaire) par défaut de Lazarus.%0:sSi vous continuez, elle sera changée en une installation secondaire.%0:s%0:s%0:sVoulez-vous continuer l'installation ?

FolderForSecondBadUninstall=Le dossier de destination n'est pas vide. Le programme d'installation n'a pas pu vérifier s'il est sûr de l'utiliser.%0:sVeuillez choisir un dossier vide ou un dossier avec une installation secondaire existante de Lazarus à mettre à jour.

SecondConfCapt=Choisissez le dossier de configuration
...
FolderForConfNotEmpty=Le dossier choisi n'est pas vide.
...
OldInOtherFolder3=Remarque : vous n'avez pas choisi de dossier de configuration dédié à cette installation.
...
OldInBadFolder3=Remarque : si vous souhaitez utiliser plus d'une installation, veuillez revenir en arrière pour cocher : "Créer une nouvelle installation secondaire".
...
DuringInstall=Quelques informations issues de notre FAQ : http://wiki.lazarus.freepascal.org/Lazarus_Faq/fr%0:s%0:s    Qu'est-ce que Lazarus ?%0:sLazarus est un EDI multiplateforme pour Pascal. Sa devise est "écrire une fois, compiler partout".%0:s%0:s    Comment réduire la taille des fichiers exécutables ?%0:sLes fichiers binaires produits par défaut sont volumineux parce qu'ils incluent des informations de débogage. Pour les versions de production, vous pouvez désactiver la production de ces informations au niveau des options du projet.%0:s%0:s    Licence : %0:s- La LCL est distribuée sous licence LGPL avec une exception pour l'édition de liens. Cette licence vous autorise à créer des applications avec la licence que vous voulez, y compris commerciale. L'EDI est sous licence GPL. Si vous distribuez un EDI modifié, vous devez suivre les indications de la GPL.%0:s- Les autres paquets et composants ont des licences variées. Consultez le fichier "readme" de chacun d'eux.
